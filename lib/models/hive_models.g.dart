...
class UserAdapter extends TypeAdapter<User> {
  ...
  User read(BinaryReader reader) {
    ...
    return User(
      ...
      cart: (fields[7] as Map?)?.cast<String, int>(),
      portfolio: (fields[8] as Map?)?.cast<String, double>(),
      investmentSettings: (fields[9] as Map?)?.cast<String, double>(),
    );
  }
